  ...
  <div class="container py-4">
    <div class="row">
      ...
      <div class="col-lg-6  py-3" id="font-login">
        <h2 style="text-align:center; color: #da7070; padding-top:30px">ĐĂNG NHẬP TÀI KHOẢN</h2>
        ...
        <form action=<?= $linkBE . "login_process.php" ?> method="post">
          ...
          <div class="flex-row" style=" margin: 15px 5px;">
            <div>
              ...
              <div class="text-center p-3">
                ...
                <a class="btn btn-primary" href="./resetpass.php">Đăng ký</a>
              </div>
            </div>
        </form>
      </div>
