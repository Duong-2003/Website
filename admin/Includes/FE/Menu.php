  ...
  <div class="b-example-divider b-example-vr" ></div>
      ...
      <div class="offcanvas-body">
        <ul class="navbar-nav justify-content-end flex-grow-1 pe-3 ">
          ...
          <li class="nav-item">
          <a class="nav-link" href="admin_users.php"> Danh mục Loại Sản phẩm </a>
           
          </li>
          <li class="nav-item">
          <a class="nav-link" href="admin_products.php"> Danh mục Sản phẩm </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="admin_orders.php"> Danh mục Người dùng</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="admin_register.php">  Danh mục Đơn hàng</a>
          </li>
