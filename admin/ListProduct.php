...
<script>
  ...
  <div class="content" style="padding: 0 30px;">
            ...
            <tr>
              ...
              <td>
                <div class="container text-center">
                  <div class="row gx-2">
                    <div class="col">
                    <div class="p-2"><a href="./DeleteSQL.php?key=sp_ma&table=sanpham&datakey=<?= $sp['sp_ma']?>">Xóa</a></div>
                    </div>
                    <div class="col">
                    <div class="p-2"><a href="./Alter_product.php?key=sp_ma&table=sanpham&datakey=<?= $sp['sp_ma']?>"">Sửa</a></div>
                    </div>
                  </div>
                </div>
              </td>
    ...
    <div >
    <span class="log_heading text-dark mb-3"><h5>Thêm sản phẩm</h5></span>
