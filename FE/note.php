 ...
 <!-- ____________________________________HEADER________________________________________ -->
    ...
    <div class="container" >
            <div class="row py-2 " style="text-align: center;">
                ...
                <div class="col-lg-3 col-md-6" id="logo" style="padding:5px 5px">
                   <a href=""><img src="../
                   Lazada.png" alt=""style="height:50px;witdh:100%" ></a> 
                </div>

                <div class="col-lg-5 col-md-6" id="home">
                    <div class="row">
                        <ul >
                ...
                <div class="col-lg-4 col-md-6 text-white " style="text-align:center">
                    <div class="input-group mb-3 " style="padding:5px 5px">
    ...
    <!-- __________________________________SLIDER____________________________ -->
...
<!-- _________________________________CONTENT___________________________________ -->
    ...
    <!-- ____________________________________________________FOOTER________________________________________________ -->
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                            <h5>THIÊN ĐƯỜNG MUA SẮM </h5>
                               ...
                               <p class="m-0"> Chứng nhận:Việt Nam </p>
                        ...
                        <div class="input-group mb-3">
                            <input type="text" class="form-control" placeholder="Nhấn để tìm kiếm" >
                            <span class="input-group-text" style="background-color:pink"><a style="text-decoration: none;color: rgb(217, 58, 58)" href="">Đăng kí</a>
                          </div>
                          <span>
